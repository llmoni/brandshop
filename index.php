...
<div id="content">
    <?php
        ...
        $goods = [
            ...
            'id' => 1,
            'name' => 'Iphone',
            'desc' => 'Повседневная практика показывает, что экономическая повестка сегодняшнего дня обеспечивает актуальность соответствующих условий активизации.',
...
<footer>
    <div id="footerInside">
        ...
        <div id="copyrights">&copy; 2021- <?php echo date("Y");?> Maksimov Vitaliy</div>
    </div>
</footer>
